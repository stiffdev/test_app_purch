...
class DaysDatabaseHelper {
  ...
  String colExId = 'id';
  String colDay = 'day';
  String colCompleted1 = 'false';
  String colCompleted2 = 'false';
  String colCompleted3 = 'false';

  DaysDatabaseHelper._createInstance(); // Named constructor to create instance of ExamDatabaseHelper

  factory DaysDatabaseHelper() {
    if (_databaseHelper == null) {
      _databaseHelper = DaysDatabaseHelper
  ...
  void _createDb(Database db, int newVersion) async {
    await db.execute('CREATE TABLE $examsTable($colExId TEXT '
        '$colDay INTEGER,   $colCompleted1 TEXT,  $colCompleted2 TEXT, $colCompleted3 TEXT   )');
  }
/*
